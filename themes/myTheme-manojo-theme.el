...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:height 0.9 :box (:line-width 1 :color nil :style nil) :foreground "Blue" :background "Black"))))
 '(mode-line-buffer-id ((t (:background "blue" :foreground "brightwhite" :weight extra-bold :height 0.9))))
